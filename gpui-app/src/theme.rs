...
fn dark() -> Theme {
    Theme {
        ...
        kind_object: rgb(0x4c8dff).into(),
        kind_interface: rgb(0x9d7bff).into(),
        kind_union: rgb(0xd9a441).into(),
        kind_enum: rgb(0x4dbd82).into(),
        kind_input: rgb(0x3fb6c9).into(),
        kind_scalar: rgb(0x8b93a3).into(),
    }
}
...
fn light() -> Theme {
    Theme {
        ...
        type_amber: rgb(0x9a6b00).into(),
        red: rgb(0xc93c34).into(),
        overlay_green: rgb(0x0d9668).into(),
        arg_orange: rgb(0xb05a1f).into(),
        accent: rgb(0x2160c4).into(),
        shadow: gpui::black().opacity(0.18),
        kind_object: rgb(0x2160c4).into(),
        kind_interface: rgb(0x6b46c1).into(),
        kind_union: rgb(0x9a6b00).into(),
        kind_enum: rgb(0x1a7f4b).into(),
        kind_input: rgb(0x0e7490).into(),
        kind_scalar: rgb(0x5a6372).into(),
    }
}
